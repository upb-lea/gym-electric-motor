...
class DqContCurrentControlPermanentMagnetSynchronousMotorEnv(ElectricMotorEnvironment):
    """
        Description:
            Environment to simulate a dq-domain cont. control set torque controlled permanent magnet synchronous motor
