...
class DqContTorqueControlPermanentMagnetSynchronousMotorEnv(ElectricMotorEnvironment):
    """
        Description:
            Environment to simulate a  dq-domain continuous control set torque controlled permanent magnet synchronous
            motor
