...
class DqContCurrentControlSquirrelCageInductionMotorEnv(ElectricMotorEnvironment):
    """
        Description:
            Environment to simulate a dq-domain cont. control set torque controlled squirrel cage induction motor
