...
class AbcContTorqueControlSquirrelCageInductionMotorEnv(ElectricMotorEnvironment):
    """
        Description:
            Environment to simulate a  abc-domain continuous control set torque controlled squirrel cage induction motor
        ...
        Default Components:
            ...
            Reward Function:
                WeightedSumOfErrors: reward_weights 'torque' = 1.0
        ...
        Action Space:
            Type: Type: Box(low=[-1,-1,-1], high=[1,1,1])
