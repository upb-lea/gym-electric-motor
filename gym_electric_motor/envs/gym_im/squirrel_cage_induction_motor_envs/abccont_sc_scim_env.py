...
class AbcContSpeedControlSquirrelCageInductionMotorEnv(ElectricMotorEnvironment):
    """
        Description:
            Environment to simulate a abc-domain cont. control set speed controlled squirrel cage induction motor
