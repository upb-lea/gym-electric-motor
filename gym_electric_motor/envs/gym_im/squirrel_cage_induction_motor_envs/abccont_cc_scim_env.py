...
class AbcContCurrentControlSquirrelCageInductionMotorEnv(ElectricMotorEnvironment):
    """
        Description:
            Environment to simulate a abc-domain cont control set torque controlled squirrel cage induction motor
