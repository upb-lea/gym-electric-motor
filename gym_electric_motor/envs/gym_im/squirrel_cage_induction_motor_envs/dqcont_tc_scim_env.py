...
class DqContTorqueControlSquirrelCageInductionMotorEnv(ElectricMotorEnvironment):
    """
        Description:
            Environment to simulate a dq-domain continuous control set torque controlled squirrel cage induction motor
