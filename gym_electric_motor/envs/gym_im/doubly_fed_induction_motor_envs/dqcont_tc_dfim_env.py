...
class DqContTorqueControlDoublyFedInductionMotorEnv(ElectricMotorEnvironment):
    """
        Description:
            Environment to simulate a dq-domain continuous control set torque controlled doubly fed induction motor
