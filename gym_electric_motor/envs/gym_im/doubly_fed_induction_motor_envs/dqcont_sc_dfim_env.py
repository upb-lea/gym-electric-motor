...
class DqContSpeedControlDoublyFedInductionMotorEnv(ElectricMotorEnvironment):
    """
        Description:
            Environment to simulate a dq-domain cont. control set speed controlled doubly fed induction motor
