...
class DqContCurrentControlDoublyFedInductionMotorEnv(ElectricMotorEnvironment):
    """
        Description:
            Environment to simulate a dq-domain cont. control set torque controlled doubly fed induction motor
