...
class AbcContCurrentControlDoublyFedInductionMotorEnv(ElectricMotorEnvironment):
    """
        Description:
            Environment to simulate a abc-domain cont control set torque controlled doubly fed induction motor
        ...
        Default Components:
            ...
            Converter: ContMultiConverter(ContB6BridgeConverter, ContB6BridgeConverter)
            Motor: DoublyFedInductionMotor
