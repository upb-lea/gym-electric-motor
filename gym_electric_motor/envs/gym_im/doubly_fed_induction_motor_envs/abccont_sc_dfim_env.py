...
class AbcContSpeedControlDoublyFedInductionMotorEnv(ElectricMotorEnvironment):
    """
        Description:
            Environment to simulate a abc-domain cont. control set speed controlled doubly fed induction motor
