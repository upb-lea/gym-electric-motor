...
class DqContTorqueControlExternallyExcitedSynchronousMotorEnv(ElectricMotorEnvironment):
    """
    Description:
        Environment to simulate a dq-domain continuous control set torque controlled permanent magnet synchr. motor.
