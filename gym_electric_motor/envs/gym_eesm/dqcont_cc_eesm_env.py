...
class DqContCurrentControlExternallyExcitedSynchronousMotorEnv(ElectricMotorEnvironment):
    """
    Description:
        Environment to simulate a dq-domain continuous control set current controlled permanent magnet synchr. motor.
