...
class DqContCurrentControlSynchronousReluctanceMotorEnv(ElectricMotorEnvironment):
    """
        Description:
            Environment to simulate a dq-domain cont. control set torque controlled synchronous reluctance motor
