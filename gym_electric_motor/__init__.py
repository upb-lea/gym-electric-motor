...
register(id='Finite-SC-ExtExDc-v0',
...
register(id='Finite-TC-ExtExDc-v0',
...
register(id='Finite-CC-ExtExDc-v0',
...
register(id='Finite-SC-SeriesDc-v0',
...
register(id='Finite-TC-SeriesDc-v0',
...
register(id='Finite-CC-SeriesDc-v0',
...
register(id='Finite-SC-ShuntDc-v0',
...
register(id='Finite-TC-ShuntDc-v0',
...
register(id='Finite-CC-ShuntDc-v0',
