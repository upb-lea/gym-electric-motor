...
class FluxObserver(PhysicalSystemWrapper):
    ...
    def __init__(self, current_names=('i_sa', 'i_sb', 'i_sc'), physical_system=None):
        ...
        self._integrated = np.complex128(0, 0)
    ...
    def simulate(self, action):
        ...
        delta_psi = np.complex128(i_s_alpha, i_s_beta) * self._r_r * self._l_m / self._l_r \
            - self._integrated * np.complex128(self._r_r / self._l_r, -omega)
