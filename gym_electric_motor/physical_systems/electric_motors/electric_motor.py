...
class ElectricMotor(RandomComponent):
    ...
    #: _num_motors(int): number of motors to simulate, is equal to number ov environments
    _num_motors = 1

    @property
    def num_motors(self):
        """
        Readonly number of motors to be simulated
    ...
    def __init__(
            ...
            initial_limits=None, num_motors = 1
    ):
        """
